...
class CustomButton extends StatelessWidget {
  ...
  CustomButton({this.onPressed, required this.buttonText, this.transparent = false, this.margin =  const EdgeInsets.all(0), this.width =0 , this.height =0,
    this.fontSize = 14, this.icon, this.backgroundColor =  Colors.transparent , this.fontColor =  Colors.transparent });
  ...
  Widget build(BuildContext context) {
    final ButtonStyle _flatButtonStyle = TextButton.styleFrom(
      ...
      minimumSize: Size(width != null ? width : 1170, height != null ? height : 40),
