  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: Colors.grey[Get.isDarkMode ? 800 : 200] ?? Colors.grey, blurRadius: 5, spreadRadius: 1)],
      ),
          ...
          Expanded(child: TextButton(
            onPressed: () {
              Get.toNamed(
                ...
                arguments: OrderDetailsScreen(orderModel: orderModel, isRunningOrder: isRunningOrder, orderIndex: orderIndex, from: null,),
              );
            },
