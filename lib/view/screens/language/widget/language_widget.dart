    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: Colors.grey[Get.isDarkMode ? 800 : 200] ??  const Color(0xFF000000), blurRadius: 5, spreadRadius: 1)],
        ),
          ...
          Center(
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(Dimensions.RADIUS_SMALL),
                  border: Border.all(color: Theme.of(context).textTheme.bodyText1?.color ??  const Color(0xFF000000), width: 1),
                ),
