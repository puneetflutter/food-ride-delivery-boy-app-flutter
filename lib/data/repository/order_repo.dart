...
class OrderRepo extends GetxService {
  ...
  Future<Response> getLatestOrdersss() async {
    print("cherry");
    dynamic res;
    res = await apiClient
        .getData(AppConstants.LATEST_ORDERS_URI + getUserToken());
    print("i am in res.......$res");
    return res;
    //  apiClient.getData(AppConstants.LATEST_ORDERS_URI + getUserToken());
  }
  ...
  String getUserToken() {
    ...
    setIgnoreList(List<IgnoreModel> ignoreList) {
  ...
  Future<Response> getReturnRequest(String order_id, String id, String reason) {
    return apiClient.postData(AppConstants.RETURN_ORDERS_REQ_URI,
        {"dm_id": id, 'reason': reason, 'order_id': order_id});
  }

  Future<Response> ReturnOrderComplete(String order_id, String id) {
    return apiClient.postData(AppConstants.COMPLETE_RETURN_ORDERS_URI,
        {"dm_id": id, 'order_id': order_id});
  }
}
