...
class AppConstants {
  static const String APP_NAME = 'Foodride Delivery Partner';
  static const double APP_VERSION = 6.0;

  // static const String BASE_URL = 'https://web.livework.in/web';
  static const String BASE_URL = 'https://web.foodride.in';
  ...
  static const String RETURN_ORDERS_REQ_URI =
      '/api/v1/delivery-man/awt-return-order';
  static const String COMPLETE_RETURN_ORDERS_URI =
      '/api/v1/delivery-man/awt-accept-return-order';
  // static const String LATEST_ORDERS_URI = '/api/v1/delivery-man/latest-orders?token=';
  static const String LATEST_ORDERS_URI =
      '/api/v1/delivery-man/awt-latest-orders?token=';
